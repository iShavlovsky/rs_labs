...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String &
      ...
      Attribute.DefaultTo<'title article'>;
    description: Attribute.Text &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 1;
      }> &
      Attribute.DefaultTo<'basic description'>;
    cover: Attribute.Media & Attribute.Required;
    timeRead: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }> &
    ...
    writtenBy: Attribute.String &
      ...
      Attribute.DefaultTo<'ALEX VOINOVITCH'>;
    date: Attribute.Date &
      Attribute.Required &
      Attribute.DefaultTo<'2023-10-01'>;
